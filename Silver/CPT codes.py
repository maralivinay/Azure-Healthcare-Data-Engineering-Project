...
# Read the CSV file
cptcodes_df = spark.read.csv("abfss://landing@storagevinaydataproject.dfs.core.windows.net/Cptcodes/*.csv",
    header=True
)
...
cptcodes_df.write.format("parquet") \
    .mode("overwrite") \
    .save("abfss://bronze@storagevinaydataproject.dfs.core.windows.net/cpt_codes/")
